...
// ----------------------------------------------------------------------
// 1. สร้าง Component ย่อย (CartContent) เพื่อรับหน้าที่เรียกใช้ useSearchParams
// ----------------------------------------------------------------------
...
// ----------------------------------------------------------------------
// 2. หน้าหลัก (Default Export) ที่ทำหน้าที่เป็นเปลือกนอก และจัดการ Layout
// ----------------------------------------------------------------------
export default function CartPage() {
    return (
        <SidebarProvider>
            <AppSidebar />
            {/* Suspense Boundary: ป้องกัน Error ตอน Build และโชว์ Loading ตอนดึงข้อมูล URL */}
            <Suspense fallback={
                <SidebarInset>
