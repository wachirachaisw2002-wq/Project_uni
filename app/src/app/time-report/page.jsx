...
export default function TimeReportPage() {
  ...
  return (
    <SidebarProvider>
      <AppSidebar />
      {/* 🔴 SidebarInset: ใช้ h-screen + overflow-hidden เพื่อล็อคความสูงหน้าจอไม่ให้ Scroll 
          ใช้ flex-col เพื่อแบ่ง Header กับ Main
      */}
      <SidebarInset className="dark:bg-black h-screen flex flex-col overflow-hidden w-full">
        ...
        {/* 🔴 Main Content: 
            - flex-1: กินพื้นที่ที่เหลือจาก Header
            - overflow-y-auto: ให้ Scroll เฉพาะในส่วนเนื้อหานี้
            - p-2: ลด Padding ให้ดูกระชับ
        */}
        <main className="flex-1 overflow-y-auto p-2 sm:p-4 bg-zinc-50/30 dark:bg-black w-full">
           
           {/* 🔴 Container: 
              - max-w-3xl: บีบเนื้อหาให้แคบลง (จากเดิมเต็มจอ) ให้อ่านง่าย 
              - mx-auto: จัดกึ่งกลาง
           */}
             ...
             <Card className="border-none shadow-sm overflow-hidden dark:bg-zinc-900/40 dark:ring-1 dark:ring-zinc-800">
                <CardContent className="p-0">
                   <div className="overflow-x-auto w-full">
                     <Table className="min-w-[600px]"> {/* ลด min-w ลงเพื่อให้เลื่อนน้อยลงในมือถือ */}
